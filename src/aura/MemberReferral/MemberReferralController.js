({    
    ...
    doInit: function(cmp, event, helper){     
        ...
        var loggedInSetup = cmp.get("v.loggedInMember"); //console.log('loggedInSetup: '+loggedInSetup);
        var callSearchMember = cmp.get("v.callSearchMember");
        if(loggedInSetup){
        ...
        }else if(callSearchMember){
            console.log('callSearchMember');
        }else{
            var url;
            if(url == null){
    ...
    handleSearchMember:function(cmp, event, helper){
        var member = event.getParam("memberId");
        cmp.set("v.member", member); 
        console.log('member: '+cmp.get("v.member"));
    },
})